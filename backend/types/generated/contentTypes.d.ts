...
export interface ApiParentProductParentProduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'parent_products';
  info: {
    description: 'Parent Product schema';
...
export interface ApiProductVariantProductVariant
  ...
  info: {
    description: 'Product Variant schema';
  ...
  attributes: {
    ...
    gallery_images: Schema.Attribute.Media<undefined, true>;
    hex_color: Schema.Attribute.String;
    imprint_required: Schema.Attribute.Boolean;
    information_files: Schema.Attribute.Media<undefined, true>;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usb_item: Schema.Attribute.Boolean;
